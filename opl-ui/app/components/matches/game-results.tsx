  ...
  return (
    <Box>
      ...
      {games.map((game, index) => {
        ...
        const [winnerWeight, loserWeight] = getMatchWeight(game.winner_rating, game.loser_rating);
        ...
        return (
          ...
          >
            ...
            <Typography component="span">
              ...
              <TrendingUpIcon sx={{ fontSize: 14, verticalAlign: 'middle', ml: 0.5, mr: 0.25, color: 'success.main' }} />
            ...
            <Typography component="span">
              ...
              <TrendingDownIcon sx={{ fontSize: 14, verticalAlign: 'middle', ml: 0.5, mr: 0.25, color: 'error.main' }} />
